...
const NAV = [
  ...
  { to: "/performance", icon: TrendingUp, key: "nav.performance" },
    ...
    >
      ...
      <div className="flex h-16 items-center gap-3 border-b border-sidebar-border px-5">
        ...
        <div className="flex flex-col leading-tight">
          <span className="text-sm font-semibold text-sidebar-primary-foreground">{t("app.name")}</span>
        ...
        <div className="mt-3 rounded-lg bg-sidebar-accent p-3">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1 leading-tight">
              <p className="truncate text-sm font-medium text-sidebar-primary-foreground">مطعم البركة</p>
              <p className="truncate text-[11px] text-sidebar-foreground/60">vendor@ez.app</p>
            </div>
          </div>
        </div>
      </div>
